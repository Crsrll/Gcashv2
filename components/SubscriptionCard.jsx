    ...
    <div className="bg-white rounded-2xl p-4 flex items-center gap-3.5 shadow-[0_1px_3px_rgba(0,0,0,.08)]">
      ...
      <div className="flex-1 min-w-0">
        <div className="flex items-center gap-2 flex-wrap">
          <p className="font-semibold text-[#1A1D23] text-sm truncate">{sub.name}</p>
          <span className={`text-[0.68rem] font-semibold px-2 py-0.5 rounded-full uppercase ${style.badge}`}>
            {style.label}
          </span>
        </div>
